...
mod pairwise_tests {
    ...
    // The fixture is committed so a clean checkout (CI) can compile the tests;
    // it replaces the scratch copy that used to live outside the repo.
    include!("../../tests/data/pairwise_golden_data.rs");
